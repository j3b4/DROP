...
# Explore a dungeon
The main objective is procedurally generated, instanced dungeons. That means
they are random and you can never return to the same place.

However, the build commands in a MUD make it very easy to create static,
permanent dungeons too, so likely there will be a mix.

# Die frequently in different ways
So the inspiration for this project (Dungeon Robber) assumed player's
characters would die all the time. In this MUD we can discuss character
persistance.  See more discussion in the section about becoming a legend.
...
So, in Dungeon Robber, once a character obtains sufficient wealth, they have
the option to retire. This has the effect of giving them fame and a legacy.
